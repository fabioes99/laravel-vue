  ...
  <div>
    <div v-if="shouldHaveOptions()" class="mt-2">
      ...
      <div v-for="(option, index) in model.data.options" :key="option.uuid" class="flex items-center mb-1">
        ...
        <button type="button" @click="removeOption(option)" class="h-6 w-6 ml-2 rounded-full flex items-center justify-center border border-transparent transition-colors hover:border-red-500">
